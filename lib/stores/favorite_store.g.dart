...
mixin _$FavoriteStore on _FavoriteStore, Store {
  late final _$_getFavoriteListAsyncAction =
      AsyncAction('_FavoriteStore._getFavoriteList', context: context);
  ...
  @override
  Future<void> toggleFavorite(Anuncio anuncio) {
    return _$toggleFavoriteAsyncAction.run(() => super.toggleFavorite(anuncio));
  }
